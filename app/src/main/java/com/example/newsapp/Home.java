...
public class Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv=view.findViewById(R.id.rv_home);
        Retrofit retrofit= apiclient.getRetrofit();
        api_interface apiInterface=retrofit.create(api_interface.class);
        list=new ArrayList<>();
        String country=getArguments().getString("country");
        Log.d("AWAA","c,home=="+country);

        apiInterface.getheadlines(country,"abcc7a0c4238489abe5bf52cdd5623f3",50).enqueue(new Callback<Root>() {
            @Override
